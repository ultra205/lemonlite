...
module nios2e_mm_interconnect_0 (
	...
	wire  [18:0] onchip_flash_0_csr_agent_m0_address;                                                // onchip_flash_0_csr_agent:m0_address -> onchip_flash_0_csr_translator:uav_address
	...
	wire  [97:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> onchip_flash_0_csr_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // onchip_flash_0_csr_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [7:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> onchip_flash_0_csr_agent:cp_channel
	...
	wire  [18:0] onchip_flash_0_data_agent_m0_address;                                               // onchip_flash_0_data_agent:m0_address -> onchip_flash_0_data_translator:uav_address
	...
	wire  [97:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> onchip_flash_0_data_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // onchip_flash_0_data_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [7:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> onchip_flash_0_data_agent:cp_channel
	...
	wire  [98:0] period0_s1_agent_rf_source_data;                                                    // PERIOD0_s1_agent:rf_source_data -> PERIOD0_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] period0_s1_agent_rsp_fifo_out_data;                                                 // PERIOD0_s1_agent_rsp_fifo:out_data -> PERIOD0_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> PERIOD0_s1_agent:cp_valid
	wire  [97:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> PERIOD0_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // PERIOD0_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> PERIOD0_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> PERIOD0_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> PERIOD0_s1_agent:cp_endofpacket
	...
	wire  [98:0] decode0_s1_agent_rf_source_data;                                                    // DECODE0_s1_agent:rf_source_data -> DECODE0_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] decode0_s1_agent_rsp_fifo_out_data;                                                 // DECODE0_s1_agent_rsp_fifo:out_data -> DECODE0_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> DECODE0_s1_agent:cp_valid
	wire  [97:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> DECODE0_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // DECODE0_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> DECODE0_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> DECODE0_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> DECODE0_s1_agent:cp_endofpacket
	...
	wire  [98:0] push_s1_agent_rf_source_data;                                                       // PUSH_s1_agent:rf_source_data -> PUSH_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] push_s1_agent_rsp_fifo_out_data;                                                    // PUSH_s1_agent_rsp_fifo:out_data -> PUSH_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> PUSH_s1_agent:cp_valid
	wire  [97:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> PUSH_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // PUSH_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> PUSH_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> PUSH_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> PUSH_s1_agent:cp_endofpacket
	...
	wire  [97:0] onchip_flash_0_csr_agent_rp_data;                                                   // onchip_flash_0_csr_agent:rp_data -> router_003:sink_data
	...
	wire  [97:0] onchip_flash_0_data_agent_rp_data;                                                  // onchip_flash_0_data_agent:rp_data -> router_004:sink_data
	...
	wire         period0_s1_agent_rp_valid;                                                          // PERIOD0_s1_agent:rp_valid -> router_007:sink_valid
	wire  [97:0] period0_s1_agent_rp_data;                                                           // PERIOD0_s1_agent:rp_data -> router_007:sink_data
	wire         period0_s1_agent_rp_ready;                                                          // router_007:sink_ready -> PERIOD0_s1_agent:rp_ready
	wire         period0_s1_agent_rp_startofpacket;                                                  // PERIOD0_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         period0_s1_agent_rp_endofpacket;                                                    // PERIOD0_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         decode0_s1_agent_rp_valid;                                                          // DECODE0_s1_agent:rp_valid -> router_008:sink_valid
	wire  [97:0] decode0_s1_agent_rp_data;                                                           // DECODE0_s1_agent:rp_data -> router_008:sink_data
	wire         decode0_s1_agent_rp_ready;                                                          // router_008:sink_ready -> DECODE0_s1_agent:rp_ready
	wire         decode0_s1_agent_rp_startofpacket;                                                  // DECODE0_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         decode0_s1_agent_rp_endofpacket;                                                    // DECODE0_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         push_s1_agent_rp_valid;                                                             // PUSH_s1_agent:rp_valid -> router_009:sink_valid
	wire  [97:0] push_s1_agent_rp_data;                                                              // PUSH_s1_agent:rp_data -> router_009:sink_data
	wire         push_s1_agent_rp_ready;                                                             // router_009:sink_ready -> PUSH_s1_agent:rp_ready
	wire         push_s1_agent_rp_startofpacket;                                                     // PUSH_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         push_s1_agent_rp_endofpacket;                                                       // PUSH_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [97:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_004:sink1_data
	...
	wire  [97:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> rsp_mux_001:sink2_data
	...
	wire         period0_s1_agent_rdata_fifo_src_valid;                                              // PERIOD0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] period0_s1_agent_rdata_fifo_src_data;                                               // PERIOD0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         period0_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_005:in_0_ready -> PERIOD0_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> PERIOD0_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> PERIOD0_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                  // PERIOD0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> PERIOD0_s1_agent:rdata_fifo_sink_error
	wire         decode0_s1_agent_rdata_fifo_src_valid;                                              // DECODE0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] decode0_s1_agent_rdata_fifo_src_data;                                               // DECODE0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         decode0_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_006:in_0_ready -> DECODE0_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> DECODE0_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> DECODE0_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // DECODE0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> DECODE0_s1_agent:rdata_fifo_sink_error
	wire         push_s1_agent_rdata_fifo_src_valid;                                                 // PUSH_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] push_s1_agent_rdata_fifo_src_data;                                                  // PUSH_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         push_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_007:in_0_ready -> PUSH_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> PUSH_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> PUSH_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // PUSH_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> PUSH_s1_agent:rdata_fifo_sink_error
	...
	nios2e_mm_interconnect_0_router_004 router_006 (
	...
	nios2e_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2e_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2e_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios2e_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
